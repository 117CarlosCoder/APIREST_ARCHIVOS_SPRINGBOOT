...
import com.archivos.apispringbootcunoc.persistence.repository.RoleRepository;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        userEntity.getRoles().stream().flatMap(role -> role.getPermissionList().stream()).forEach(permission -> {authorityList.add(new SimpleGrantedAuthority(permission.getName()));
            System.out.println("Permisos de usuario " + permission.getName());});
    ...
    public AuthResponse loginUser(AuthLoginRequest authLoginRequest) {
        ...
        String accessToken = jwtUtils.createToken(authentication, userEntity.getSucursal(), userEntity.getId().toString());
